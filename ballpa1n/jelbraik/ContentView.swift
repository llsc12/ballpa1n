...
"""),
    ...
    StageStep(status: "Running pen1ledefunc untether(er)", avgInterval: 0.6, consoleLogs: [
        ConsoleStep(delay: 0.1, line: "[*] Stage (30): Running pen1le3xplo1t"),
        ConsoleStep(delay: 2, line: "[+] Ensuring untethered boot")
    ]),
